class pack_territoryhq extends RecipeBase	
{	
	override void Init()
	{
		m_Name = "Pack";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"TerritoryHQ");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("TerritoryHQ_Kit");//add results here
